...
![image-20200526193011677](https://chanx-1251137349.file.myqcloud.com/image-20200526193011677.png)

不使用分组交换的话，两端通信需要占用整一段链路进行传输（图中黑色部分有4段）

**使用分组交换后，在哪段链路上传送才占用这段链路的通信资源**

![image-20200526193011677](https://chanx-1251137349.file.myqcloud.com/image-20200526192949223.png)
