---
title: 网页性能优化 - 加载速度
description: 网页性能优化-加载速度
createDate: 2021-12-09T00:00:00.000Z
updateDate: 2021-12-09T00:00:00.000Z
image: https://cdn.chanx.tech/image/covers/web-performance-loading-speed.webp
tags:
  - frontend
draft: false
sticky: false
...
![img](https://cdn.chanx.tech/image/tecgj_0.png)

![img](https://cdn.chanx.tech/image/tea40_0.png)
...
<img src="https://cdn.chanx.tech/image/te9fs_0.png" alt="img" style="zoom:50%;" /><img src="https://cdn.chanx.tech/image/teazg_0.png" alt="img" style="zoom:50%;" />
...
<img src="https://cdn.chanx.tech/image/vsekn_0.png" alt="image-20220612005339741" style="zoom:50%;" />

4. `LightHouse`进行测试

![img](https://cdn.chanx.tech/image/tea1q_0.png)

![img](https://cdn.chanx.tech/image/tei5k_0.png)
...
![img](https://cdn.chanx.tech/image/teemm_0.png)
...
![img](https://cdn.chanx.tech/image/tep2m_0.png)
...
![img](https://cdn.chanx.tech/image/teqcm_0.png)

4. 部署到服务器上，使用`LightHouse`进行测试

![img](https://cdn.chanx.tech/image/tef6b_0.png)
...
<img src="https://cdn.chanx.tech/image/v85up_0.png" alt="image-20220612005244299" style="zoom:50%;" />

![](https://cdn.chanx.tech/image/tefc3_0.png

![img](https://cdn.chanx.tech/image/teq8z_0.png)
...
![img](https://cdn.chanx.tech/image/teoje_0.png)

首先看到整个文件可以大致分为四块：`sv.js`、`ace-builds`、`swiper`、`splitpanes`；分别代表的是可视化面板、编辑器、测试数据面板、分割面板组件。

![img](https://cdn.chanx.tech/image/texwq_0.png)
...
![img](https://cdn.chanx.tech/image/tet47_0.png)

拆完包之后我们打开页面验证一下：

![img](https://cdn.chanx.tech/image/teqza_0.png)

![img](https://cdn.chanx.tech/image/teq7g_0.png)

可以看到在进入页面时多加载了几个js文件，单个文件的体积比较小，没有超过200K

Coding页面的首次加载优化已经算完成了，继续看看调试状态下的加载

![img](https://cdn.chanx.tech/image/ter49_0.png)
...
![img](https://cdn.chanx.tech/image/tev2g_0.png)
...
<img src="https://cdn.chanx.tech/image/tf5yq_0.png" alt="img" style="zoom: 33%;" />
