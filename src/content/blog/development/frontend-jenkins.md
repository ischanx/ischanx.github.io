---
title: 前端工程化之Jenkins
description: 前端工程化之Jenkins
createDate: 2021-11-14T00:00:00.000Z
updateDate: 2021-11-14T00:00:00.000Z
image: https://cdn.chanx.tech/image/covers/frontend-jenkins-pipeline.webp
tags:
  - frontend
  - engineering
draft: false
...
![img](https://cdn.chanx.tech/image/nvzng_0.png)
...
![img](https://cdn.chanx.tech/image/nw0j5_0.png)
...
![img](https://cdn.chanx.tech/image/nw3sc_0.png)

1. 将`id_dsa.pub`公钥配置到Git Server中

![img](https://cdn.chanx.tech/image/nw2z6_0.png)![img](https://cdn.chanx.tech/image/nw2rp_0.png)

### 配置FTP Server

![img](https://cdn.chanx.tech/image/nw3bb_0.png)![img](https://cdn.chanx.tech/image/nvyl8_0.png)



### 配置Node环境

![img](https://cdn.chanx.tech/image/nw8qr_0.png)![img](https://cdn.chanx.tech/image/nwa3q_0.png)
...
![img](https://cdn.chanx.tech/image/nwc4b_0.png)

3. 配置Git仓库地址，没有凭证则需要添加

![img](https://cdn.chanx.tech/image/nw8ep_0.png)

4. 配置构建命令，通过Shell命令执行

![img](https://cdn.chanx.tech/image/nw6ru_0.png)

5. 构建后进行打包保存和FTP服务器部署

![img](https://cdn.chanx.tech/image/nwgrz_0.png)

6. 保存配置，执行构建

![img](https://cdn.chanx.tech/image/nwhz9_0.png)
